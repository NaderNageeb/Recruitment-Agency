            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  <tbody>
                    <?php 
                        $sql = "SELECT * FROM `tbljob` j, `tblcompany` c WHERE j.`COMPANYID`=c.`COMPANYID` and j.JOBSTATUS = 'Open' ORDER BY DATEPOSTED DESC LIMIT 10";
                        $mydb->setQuery($sql);
                        ...
                        foreach ($cur as $result) {
                          ...
                          echo '<td class="mailbox-date">'.$result->end_date.'</td>';
