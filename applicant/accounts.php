                  ...
                  <div class="col-md-6">
                    <div class="input-group">
                       ...
                       <input class="form-control input-sm" id="BIRTHPLACE" name="BIRTHPLACE" placeholder=
                          "Place of Birth" type="hidden" value="<?php $appl->BIRTHPLACE;?>" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off"></input>
                ...
                <div class="col-md-11">
                  ...
                  <div class="col-md-6">
                     ...
                     <input class="form-control input-sm" id="TELNO" name="TELNO" placeholder=
                        "Contact No." type="number" any value="<?php echo $appl->CONTACTNO;?>" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                  </div>
                </div>
              </div> 
              ...
              <div class="form-group">
                <div class="col-md-11">
			      ...
			      <select  class="form-control input-sm" id="DEGREE" name="DEGREE" 
					...
					<option value="<?php echo $appl->DEGREE;?>" selected><?php echo $appl->DEGREE;?></option>
