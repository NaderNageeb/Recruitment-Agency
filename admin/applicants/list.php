							...
							<table id="dash-table" class="table table-striped  table-hover table-responsive" style="font-size:12px" cellspacing="0">
							  ...
							  <tbody>
							  	<?php   
									...
									?>
							  		<td><?php if($result->admin_app_1 == 0)echo "Pending"; if($result->admin_app_1 == 1)echo "Approved";  if($result->admin_app_1 == 1 && $result->PENDINGAPPLICATION == 0)echo "Approved BY Company"; ?>  </td>
									<?php  
