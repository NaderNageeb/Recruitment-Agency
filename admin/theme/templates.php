...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>AROOMA ADMIN</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>AROOMA ADMIN</b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu"> 
        ...
        <li class="<?php echo (currentpage() == 'applicants') ? "active" : false;?>" > 
          <a href="<?php echo web_root ;?>admin/applicants/">
            ...
            <span class="label label-primary pull-right">
              <?php
                $sql = "SELECT count(*) as 'APPL' FROM `tbljobregistration` WHERE `admin_app_1`= 0";
                $mydb->setQuery($sql);
       ...
       <!--  <li class="treeview">
        ...
        <li class="<?php echo (currentpage() == 'employee') ? "active" : false;?>">
          <a href="<?php echo web_root; ?>admin/employee/">
            <i class="fa fa-user"></i> <span>employee</span> </a>
        </li>


        
        <li class="<?php echo (currentpage() == 'filter') ? "active" : false;?>">
          <a href="<?php echo web_root; ?>admin/filter/">
            <i class="fa fa-filter fa-fw"></i> <span>filtering</span> </a>
        </li>
