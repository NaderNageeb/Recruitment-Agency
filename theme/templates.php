...
<head>
<meta charset="utf-8">
<title>AROOMA / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i><a href="#">Tel No. +249-990-0009-07</a></p>
                <?php if (isset($_SESSION['APPLICANTID'])) { 

                    $sql = "SELECT count(*) as 'COUNTNOTIF' FROM `tbljob` where JOBSTATUS ='Open' ORDER BY `DATEPOSTED` DESC";
                    $mydb->setQuery($sql);
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php"><img src="<?php echo web_root; ?>plugins/home-plugins/img/logo_1.png" width="150px" height="" alt="logo"/></a>
                   
                    <!-- <a class="navbar-brand" href="<?php //echo web_root; ?>index.php">AROOMA<img src="<?php //echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/></a> -->
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                      ...
                      <li class="dropdown <?php  if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }}  ?>">
                        ...
                        <li class="<?php  if(isset($_GET['q'])) { if($_GET['q']=='hiring'){ echo 'active'; }else{ echo ''; }} ?>"><a href="<?php echo web_root; ?>index.php?q=hiring">Open Jobs</a></li>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          info@orooma.com<br>
          www.orooma.com.</address>
          <p>
            <i class="icon-phone"></i>  +249-990-0009-07
 <br>
            <i class="icon-envelope-alt"></i> info@orooma.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Futuer Uni 2022 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
          <ul class="social-network">
            <li><a href="https://www.facebook.com/OROOMA/" data-placement="top" title="Facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="https://twitter.com/OROOMA_sd" data-placement="top" title="Twitter"><i class="fa fa-twitter"></i></a></li>
