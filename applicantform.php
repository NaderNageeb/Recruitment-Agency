		...
		<div class="col-md-8">
		  <input name="JOBID" type="hidden" value="<?php echo $_GET['job'];?>">
		   <input class="form-control input-sm" id="FNAME" name="FNAME" placeholder=
		      "Firstname" onkeydown="return /[a-z]/i.test(event.key)" type="text" value=""  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
		</div>
	</div>
</div>
	...
	<div class="col-md-11">
		...
		<div class="col-md-8">
		  ...
		  <input  class="form-control input-sm" id="LNAME" name="LNAME" placeholder=
		      "Lastname" onkeydown="return /[a-z]/i.test(event.key)"   onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
		  </div>
	</div>
</div>
	...
	<div class="col-md-11">
		...
		<div class="col-md-8">
		  ...
		  <input  class="form-control input-sm" id="MNAME" name="MNAME" placeholder=
		      "Middle Name" onkeydown="return /[a-z]/i.test(event.key)"   onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
	...
	<div class="col-md-11">
		...
		<div class="col-md-8">
		 ...
		 <textarea class="form-control input-sm" id="ADDRESS" name="ADDRESS" placeholder=
		    "Address" type="text" onkeydown="return /[a-z]/i.test(event.key)" value="" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off"></textarea>
		</div>
	</div>
</div> 
  ...
  <div class="col-md-11">
    ...
    <div class="col-md-8">
       ...
       <input class="form-control input-sm" id="TELNO" name="TELNO" placeholder=
          "Contact No." type="number" any value="" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
    </div>
  </div>
</div> 
