...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo web_root;?>/employees/" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>AROOMA</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>AROOMA</b></span>
    </a>
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <?php
              $user = New User();
              $singleuser = $user->single_user_2($_SESSION['EMP_USERID']);

          ?>
          <!-- User Account: style can be found in dropdown.less -->
          <li class="dropdown user user-menu" style="padding-right: 15px;"  >
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo web_root.'employees/user/'. $singleuser->	EMPPHOTO;?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $singleuser->FNAME; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <?php  //echo $_SESSION['ADMIN_COMPANYID'];     ?>
              <li class="user-header"> 
                <img data-target="#menuModal"  data-toggle="modal"  src="<?php echo web_root.'employees/user/'. $singleuser->EMPPHOTO;?>" class="img-circle" alt="User Image" />  
              </li> 
              <!-- Menu Footer-->
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo web_root.'employees/user/index.php?view=view&id='.$_SESSION['EMP_USERID'] ;?>" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo web_root ;?>employees/logout.php" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="<?php echo web_root; ?>employees/user/controller.php?action=photos" enctype="multipart/form-data" method=
                                "post">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu"> 
        ...
        <li class="<?php echo (currentpage() == 'reports') ? "active" : false;?>">
          <a href="<?php echo web_root; ?>employees/reports/">
            <i class="fa fa-book fa-fw"></i> <span>Reports</span> </a>
        </li>
        <!-- <li class="<?php // echo (currentpage() == 'category') ? "active" : false;?>" > 
          <a href="<?php // echo web_root ;?>employees/category/">
       ...
       <!--  <li class="treeview">
         ...
         <!-- <li class="<?php //echo (currentpage() == 'user') ? "active" : false;?>">
          <a href="<?php // echo web_root; ?>employees/user/">
      ...
      <ol class="breadcrumb">
        <?php
          ...
          if ($title!='Home') {
            ...
            echo '<li><a href='.web_root.'employees/><i class="fa fa-dashboard"></i> Home</a></li>';
            echo  $active_title;
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="#">Futuer Uni</a>.</strong> All rights
    reserved.
  </footer>
   ...
   <!--      <script src="<?php echo web_root; ?>employees/js/jquery.dataTables.min.js"></script>
<script src="<?php echo web_root; ?>employees/js/dataTables.bootstrap.min.js"></script>
 <script type="text/javascript" src="<?php echo web_root; ?>js/jquery-1.10.2.js"></script>       
        ...
        <script src="<?php echo web_root; ?>employees/js/ekko-lightbox.js"></script>
        <script src="<?php echo web_root; ?>employees/js/lightboxfunction.js"></script> 
  -->
<!-- jQuery 2.1.4 --> 
