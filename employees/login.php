...
if(isset($_POST['btnLogin'])){
  ...
  //it creates a new objects of member
    ...
    $res = $user->userAuthentication_2($email, $h_upass);
    if ($res==true) { 
       message("You logon as ".$_SESSION['ROLE'].".","success");
      // if ($_SESSION['ROLE']=='Administrator' || $_SESSION['ROLE']=='Cashier'){

         $_SESSION['EMP_USERID'] = $_SESSION['USERID'];
         $_SESSION['EMP_FULLNAME'] = $_SESSION['FULLNAME'] ;
         $_SESSION['EMP_USERNAME'] =$_SESSION['USERNAME'];
         $_SESSION['EMP_ROLE'] = $_SESSION['ROLE'];
         $_SESSION['EMP_PICLOCATION'] = $_SESSION['PICLOCATION'];
         $_SESSION['EMP_COMPANYID'] = $_SESSION['COMPANY_ID'];
