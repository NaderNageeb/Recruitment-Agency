...
$conn = mysqli_connect("localhost", "root", "", "erisdb");
$sql = "SELECT COUNT(JOBID) As c from tbljob where `COMPANYID` = $company_id  ";
$query = mysqli_query($conn, $sql);
$values = mysqli_fetch_assoc($query);
$num_rows = $values['c'];
echo $num_rows;              
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              ...
              <?php
               $company_id = $_SESSION['EMP_COMPANYID'];
$conn = mysqli_connect("localhost", "root", "", "erisdb");
$sql = "SELECT COUNT(REGISTRATIONID) As c from tbljobregistration where	`COMPANYID` = $company_id  ";
$query = mysqli_query($conn, $sql);
$values = mysqli_fetch_assoc($query);
$num_rows = $values['c'];
echo $num_rows;              
