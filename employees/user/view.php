...
if(!$_SESSION['EMP_ROLE']=='Administrator'){
  ...
  @$USERID = $_SESSION['EMP_USERID'];
    if($USERID==''){
  redirect("index.php");
}
  $user = New User();
  $singleuser = $user->single_user_2($USERID);
        ...
        <div class="col-md-4">
         <a  data-target="#myModal" data-toggle="modal" href="" title="Click here to Change Image." >
            <img alt="" style="width:500px; height:400px;"
             title="" class="img-circle img-thumbnail isTooltip" src="<?php echo web_root.'employees/user/'. $singleuser->EMPPHOTO;?>" data-original-title="Usuario"> 
         </a>  
        </div>
        <div class="col-md-6">
             ...
             <form class="form-horizontal span6" action="controller.php?action=edit&view=" method="POST">
                    ...
                    <div class="col-md-8">
                      ...
                      <!-- <div class="col-md-8"> -->
                         ...
                         <input id="USERID" name="USERID" type="Hidden" value="<?php echo $singleuser->EMPLOYEEID; ?>">
                   <!--    </div>
                    </div>
                  </div>      -->      
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="U_NAME" name="U_NAME" placeholder=
                            "Account Name" type="text" value="<?php echo $singleuser->FNAME; ?>">
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="U_USERNAME" name="U_USERNAME" placeholder=
                            "Email Address" type="text" value="<?php echo $singleuser->	EMPUSERNAME; ?>">
                      </div>
                    </div>
                  </div>
